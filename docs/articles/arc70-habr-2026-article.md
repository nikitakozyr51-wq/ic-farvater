...
Приходит ТЗ: усилитель мощности S-диапазона, цепи согласования, рабочая полоса 2,7–3,5 ГГц. Конденсаторы нужны с добротностью не хуже 500 на рабочей частоте, корпус 0402 или 0603, и чтоб по ГОСТ прошли входной контроль. Начинаешь смотреть что есть в наличии — и сразу вопрос: ARC70 подойдут? Постараюсь разобрать без воды.
...
Ключевое отличие от обычных MLCC — диэлектрик с низкими потерями на высоких частотах. В серии ARC70 используется нпо-керамика на основе составов типа NPO/C0G, что даёт стабильность ёмкости в широком температурном диапазоне и приемлемую добротность в диапазоне до нескольких гигагерц.
...
Паспортные данные ARC70 выглядят прилично. Но важно понимать, при каких условиях они справедливы.
...
По вопросам наличия конкретных типономиналов и сопроводительной документации можно уточнить напрямую на [ic-farvater.ru](https://ic-farvater.ru) — мы держим склад по основным позициям серии.

## Что проверить перед тем, как ставить ARC70 в разработку

Если коротко — чеклист из того, что реально имеет значение:
