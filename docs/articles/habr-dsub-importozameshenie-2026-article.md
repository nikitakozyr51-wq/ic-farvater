...
Я работаю с поставками ЭКБ уже шестой год, и тема D-Sub — одна из тех, где разрыв между ожиданиями и реальностью стабильно большой. Попробую разобраться конкретно: что производится, что декларируется, и как не попасть впросак при приёмке.
...
Отдельно: у нас в наличии есть разъёмы серии ЕТ — цилиндрические и прямоугольные исполнения для промышленных применений. Под D-Sub это не прямые аналоги, но в части задач, где D-Sub используется просто как многоконтактный соединитель без требования стыковки с импортным оборудованием, это рабочее решение. Подробнее по наличию — на ic-farvater.ru.
...
Вот что меня реально раздражает в этой теме. В прайс-листах встречается формулировка **«аналог, соответствует ГОСТ»**. Она ни к чему не обязывает. Это маркетинговая фраза, не техническое утверждение.
...
Если ОНЦ-ВГ закрывает задачу по параметрам — предлагаем его с протоколом испытаний «ЭКБ ТЕСТ». Если не закрывает — честно говорим об этом и предлагаем либо смежный тип разъёма, либо импортный остаток со склада с документами, пока он ещё есть.
