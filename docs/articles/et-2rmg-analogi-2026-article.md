...
> 📷 **ФОТО (обложка/КДПВ):** `images\01\et-2rmg.webp` — подпись: «Разъём серии ЕТ-2РМГ (герметичный, до +200 °C) — фото из каталога IC Фарватер»
...
> 📷 **ФОТО (в текст):** `images\01\et-2rmg-d.webp` — подпись: «ЕТ-2РМГ(Д) — блочная герметичная вилка»
> 📷 **ФОТО (в текст):** `images\01\et-2rmt-vilka.webp` — подпись: «Вилка ЕТ-2РМТ — ответная часть для розеток 2РМТ/2РМДТ»
