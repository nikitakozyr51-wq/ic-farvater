...
Пришёл запрос на 200 штук ЕТ-2РМГ-7Ш, а у поставщика их нет в наличии. Сроки поджимают, инженер говорит "найди аналог". Открываешь поиск — и начинается квест. Кто-то предлагает Souriau, кто-то советует продукцию ростовского завода, кто-то вообще не понимает, что именно тебе нужно. Знакомая ситуация? Разберём по порядку.
...
**Диаметр стыковочного узла.** Для ЕТ-2РМГ серии он стандартизован, но у "совместимых" зарубежных аналогов размерный ряд другой. Стыковка визуально может выглядеть нормально, а потом выясняется, что зазор великоват.
...
Несколько оговорок к таблице. Диапазоны указаны для серии в целом — конкретный типономинал может быть у'же. Ток указан для стандартного контакта; с золотым покрытием значения могут отличаться. TE CPC — 200 циклов по паспорту, что для ряда применений недостаточно.
...
У ЕТ-2РМГ шаг между контактами и их расположение жёстко задано ОСТ. Но у зарубежных серий (Souriau 8STA, Amphenol MR) сетка контактов другая. При одинаковом количестве контактов их координаты на плоскости разъёма не совпадают. Это выясняется только при физической попытке стыковки — в документации на это прямо не написано, надо смотреть в "pin layout diagram" и сравнивать с эталонным чертежом ОСТ.

Второй момент — замок. Если в кабельной сборке стоит байонетный замок, а аналог идёт с резьбой M27, то физически они не состыкуются вообще. Это звучит очевидно, но в реальных проектах такие вещи всплывают на этапе монтажа, когда времени на переделку уже нет.
...
Это то, что в этой теме бесит по-настоящему. Один и тот же типономинал ЕТ-2РМГ-7Ш у разных заводов-изготовителей в разные годы имеет разные ТУ в документации, разное покрытие контактов (золото vs серебро vs палладий) и иногда слегка отличающиеся посадочные размеры гайки.
...
По российским производителям картина примерно такая. Ставропольский завод "Омега" делает 2РМГ по своему ТУ 16-526.364 — это одни из наиболее распространённых разъёмов с хорошей стабильностью качества из того, что я видел в работе. Ростовский завод закрывает часть типономиналов, но температурный диапазон у гражданской серии — до +85°C, что для части авиационных применений мало.
...
Если изделие идёт в серьёзное применение, требующее подтверждения параметров, имеет смысл прогнать через входной контроль. Лаборатория "ЭКБ ТЕСТ" работает именно с такими задачами — проверка по ГОСТ, испытания на вибрацию и климатику. По разъёмам ЕТ-серии у них есть наработки.
...
По наличию конкретных типономиналов и аналогов для вашей задачи можно уточнить на [ic-farvater.ru](https://ic-farvater.ru) — там работают с серией ЕТ и смогут помочь с подбором.
